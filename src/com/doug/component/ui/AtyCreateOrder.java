...
//关于一理财页面
public class AtyCreateOrder extends KJActivity {
	...
	public void widgetClick(View v) {
		...
		switch (v.getId()) {
			case R.id.btnCharge :
				startActivity(new Intent(AtyCreateOrder.this, AtyCharge.class));
				break;
			case R.id.flright :
				startActivity(new Intent(AtyCreateOrder.this, AtyTransDetail.class));
				break;
			default :
				break;
		}
